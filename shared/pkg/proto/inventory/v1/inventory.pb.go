...
type GetPartRequest struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// UUID детали, по которой требуется инфа
	Uuid          string `protobuf:"bytes,1,opt,name=uuid,proto3" json:"uuid,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type ListPartsRequest struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// Тип детали, использующийся для фильтрации
	// UNSPECIFIED => все детали
...
const file_inventory_v1_inventory_proto_rawDesc = "" +
	...
	"\tListParts\x12\x1e.inventory.v1.ListPartsRequest\x1a\x1f.inventory.v1.ListPartsResponseBMZKgithub.com/PianyCoder/ship-trader/shared/pkg/proto/inventory/v1;inventoryv1b\x06proto3"
